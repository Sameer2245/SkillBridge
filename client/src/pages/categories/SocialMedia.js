...
import { Megaphone, Star, Clock, Shield, Filter, Grid, List, Users, TrendingUp, Share2 } from 'lucide-react';
...
const SocialMedia = () => {
  ...
  const subcategories = [
    { name: 'Social Media Management', count: 654, popular: true },
    { name: 'Content Creation', count: 432 },
    { name: 'Instagram Marketing', count: 567 },
    { name: 'Facebook Ads', count: 321 },
    { name: 'TikTok Marketing', count: 298 },
    { name: 'LinkedIn Marketing', count: 234 }
  ];
  ...
  const featuredServices = [
    {
      ...
      sellerAvatar: 'https://ui-avatars.com/api/?name=Jessica+Martinez&background=EC4899&color=fff',
      rating: 4.9,
      reviews: 1234,
      price: 50,
    ...
    {
      id: 2,
      title: 'I will create engaging social media content and posts',
      seller: 'Ryan Thompson',
      sellerAvatar: 'https://ui-avatars.com/api/?name=Ryan+Thompson&background=EC4899&color=fff',
      rating: 4.8,
      reviews: 892,
      price: 35,
    ...
    {
      id: 3,
      title: 'I will grow your Instagram followers organically',
      seller: 'Sophie Chen',
      sellerAvatar: 'https://ui-avatars.com/api/?name=Sophie+Chen&background=EC4899&color=fff',
      rating: 4.7,
      reviews: 1456,
      price: 75,
    ...
    },
    {
      ...
      seller: 'Alex Johnson',
      sellerAvatar: 'https://ui-avatars.com/api/?name=Alex+Johnson&background=EC4899&color=fff',
      rating: 4.6,
      reviews: 743,
      price: 40,
    ...
    {
      id: 5,
      title: 'I will run Facebook ad campaigns that convert',
      seller: 'Maria Rodriguez',
      sellerAvatar: 'https://ui-avatars.com/api/?name=Maria+Rodriguez&background=EC4899&color=fff',
      rating: 4.8,
      reviews: 1089,
      price: 80,
      image: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=400&h=300&fit=crop',
    ...
    {
      id: 6,
      title: 'I will optimize your LinkedIn profile and strategy',
      seller: 'David Park',
      sellerAvatar: 'https://ui-avatars.com/api/?name=David+Park&background=EC4899&color=fff',
      rating: 4.7,
      reviews: 567,
      price: 60,
      image: 'https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=400&h=300&fit=crop',
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-pink-600 via-pink-700 to-rose-600 text-white py-12 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 text-pink-100 max-w-3xl mx-auto px-4">
              Boost your brand presence with expert social media management and marketing
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <div className="flex items-center space-x-4 text-pink-200">
                <div className="flex items-center">
                  <Users className="w-5 h-5 mr-2" />
                  <span>654+ Services</span>
                </div>
                <div className="flex items-center">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <nav className="mb-8">
          <ol className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li className="text-pink-600 font-medium">Social Media</li>
          </ol>
        </nav>

        {/* Subcategories */}
        <div className="mb-8">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-6">Browse Social Media Services</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
            {subcategories.map((sub, index) => (
              <Link
                key={index}
                to={`/search?category=social-media&subcategory=${sub.name.toLowerCase().replace(' ', '-')}`}
                className="group bg-white rounded-xl p-4 shadow-sm border border-gray-100 hover:shadow-md hover:border-pink-200 transition-all duration-300"
              >
                <div className="text-center">
                  ...
                  {sub.popular && (
                    <span className="inline-block mt-2 px-2 py-1 bg-pink-100 text-pink-600 text-xs rounded-full">
                      Popular
                    </span>
                  )}
                </div>
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
              <div className="flex items-center space-x-4">
                ...
                <span className="text-gray-600">654 services available</span>
              </div>
            ...
            <div className={viewMode === 'grid' 
              ...
              {featuredServices.map((service) => (
                <Link
                  key={service.id}
                  to={`/gigs/${service.id}`}
                  className={`group bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg hover:border-pink-200 transition-all duration-300 ${
                    viewMode === 'list' ? 'flex' : ''
                  }`}
                >
                  ...
                  <div className="p-6 flex-1">
                    <div className="flex items-center space-x-3 mb-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-pink-600">{service.level}</p>
                      </div>
                    </div>
                    
                    <h3 className="font-semibold text-gray-900 mb-3 group-hover:text-pink-600 transition-colors line-clamp-2">
                      {service.title}
                    </h3>
